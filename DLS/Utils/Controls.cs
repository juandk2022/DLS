    ...
    internal class Controls
    {
        ...
        public static bool IsDLSControlDown(DLSControls controls)
        {
            switch (controls)
            {
                 ...
                 *  */
                case DLSControls.LP:
                    return Game.IsKeyDown(Settings.LP);
                case DLSControls.BOOT:
                    return Game.IsKeyDown(Settings.BOOT);
                case DLSControls.DELANTE:
                    return Game.IsKeyDown(Settings.DELANTE);
                case DLSControls.DETRAS:
                    return Game.IsKeyDown(Settings.DETRAS);
                case DLSControls.whiteLaterales:
                    return Game.IsKeyDown(Settings.whiteLaterales);
                case DLSControls.DESTELLO:
                    return Game.IsKeyDown(Settings.DESTELLO);
